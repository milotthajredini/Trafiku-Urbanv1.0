<html>
    <head>
        <link rel="stylesheet" type="text/css" href="../css/linja15v1.css">
    ...
    <a href="../index.html"><img id="logokryesore" src="../img/logofinalv3.png" style="/* margin-left: 800; */display: flex;justify-content: center;/* margin: auto; */width: 300;margin: auto;"></a>
        ...
        <h1 style="display:flex;justify-content:center;margin:auto;font-family: Montserrat;">Linja 15</h1>
        <div class="table">
        ...
        <thead>
            <tr>
                ...
                <th>Nisja Nga Prishtina</th>
                <th>Stacionet</th>
                <th>Nisa Nga Keçekolla</th>
            </tr>
        </thead>
        <div class="tbody1">
        <tbody>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
       ...
       echo "<td>".$row['Nisja nga Prishtina']."</td>";
       echo "<td>". $row['Stacionet']."</td>";
       echo "<td>". $row['Nisja nga Kecekolla']."</td>";
